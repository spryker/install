...
use Spryker\Deploy\DeployFacade;
use Spryker\Deploy\DeployFactory;
...
class DeployConsoleCommand extends Command
{
    ...
    /**
     * @return \Spryker\Deploy\CommandLine\CommandLineArgumentContainer
     */
    ...
    /**
     * @return \Spryker\Deploy\CommandLine\CommandLineOptionContainer
     */
    ...
    {
        return $this->getOptionAndComment(static::OPTION_SECTIONS, 'Deploy will only run this section(s) "%s"');
    }
    ...
    {
        return $this->getOptionAndComment(static::OPTION_GROUPS, 'Deploy will only run this group(s) "%s"');
    }
    ...
    {
        return $this->getOptionAndComment(static::OPTION_EXCLUDE, 'Deploy will exclude this group(s) or section(s) "%s"');
    }
    ...
    {
        return $this->getOptionAndComment(static::OPTION_INCLUDE_EXCLUDED, 'Deploy will include this excluded section(s) or command(s) "%s"');
    }
    ...
    /**
     * @return \Spryker\Deploy\DeployFacade
     */
    protected function getFacade(): DeployFacade
    {
