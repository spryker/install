...
class CommandBuilder implements CommandBuilderInterface
{
    ...
    /**
     * @var \Spryker\Deploy\Stage\Section\Command\Condition\ConditionFactoryInterface
     */
    protected $conditionFactory;

    /**
     * @param \Spryker\Deploy\Stage\Section\Command\Condition\ConditionFactoryInterface $conditionFactory
     */
